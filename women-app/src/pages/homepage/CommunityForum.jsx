...
export default function ChatPreview() {
  ...
  const handleBackClick = () => {
    navigate("/reproductive-phenomena");
  };
  ...
  return (
    <div className="flex h-screen bg-purple-100">
      ...
      {showWelcomeModal && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-2xl w-full p-6 shadow-xl">
            ...
            <div className="bg-gradient-to-r from-purple-200 to-purple-100 p-4 rounded-lg mb-6">
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-purple-700 to-purple-600 text-white font-bold rounded-lg 
              hover:from-purple-800 hover:to-purple-700 transition duration-200 shadow-md"
            >
              Join Our Community
            </button>
          </div>
          ...
          <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-xl">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center bg-gray-100 p-3 rounded-lg">
                ...
                <button
                  ...
                  className="bg-purple-700 hover:bg-purple-800 text-white px-3 py-1 rounded text-sm transition"
                >
            ...
            <div className="flex space-x-3">
              ...
              <a
                ...
                className="flex-1 py-2 bg-gradient-to-r from-purple-700 to-purple-600 text-white font-medium rounded-lg 
                hover:from-purple-800 hover:to-purple-700 transition duration-200 shadow-md text-center"
              >
                Open Discord
              </a>
            </div>
      ...
      {/* Server sidebar */}
      {/* Server sidebar */}
<div className="w-16 bg-purple-700 flex flex-col items-center py-4 transform -translate-x-4 relative top-[-20px]">
  <div 
    className="w-10 h-10 rounded-full bg-purple-800 flex items-center justify-center text-white font-bold mb-4 cursor-pointer hover:bg-purple-900 transition duration-200"
    onClick={() => navigate("/reproductive-phenomena")}
    title="Back to Reproductive Phenomena"
  >
    ←
  </div>
  ...
  <div className="w-10 h-10 rounded-full bg-purple-600 flex items-center justify-center text-white font-bold">
    +
      ...
      <div className="w-64 bg-purple-800 text-purple-100 flex flex-col transform -translate-x-4 relative top-[-20px]">
        ...
        <div className="p-3 bg-purple-800 mb-2">
        ...
        <div className="overflow-y-auto flex-grow">
          {categories.map((category) => (
            <div key={category.name} className="mt-3">
              <h2 className="px-4 text-xs font-semibold text-purple-300 tracking-wider">
                {category.name}
              </h2>
              <ul className="mt-1">
                  ...
                  <li
                    ...
                    className={`px-4 py-1 mx-2 rounded ${
                      selectedChannel === channel
                        ...
                        : "text-purple-300 hover:text-purple-100 hover:bg-purple-800 cursor-pointer"
                    }`}
        ...
        <div className="p-3">
          <button
            ...
            className="w-full py-2 bg-gradient-to-r from-purple-700 to-purple-600 text-white font-medium rounded
            hover:from-purple-800 hover:to-purple-700 transition duration-200 shadow-md"
          >
            Join Discord
          </button>
        ...
        <div className="p-3 bg-purple-950 flex items-center">
      ...
      <div className="w-[1200px] mx-auto bg-white shadow-lg rounded-lg h-full">
        ...
        {selectedChannel ? (
          <>
            <div className="h-14 bg-purple-800 border-b border-purple-700 flex items-center px-4">
            ...
            {/* Chat messages */}
            <div className="flex-grow overflow-y-auto p-4 bg-purple-200 w-[1200px] h-[575px]">
                    ...
                    <div key={index} className="flex items-start">
                      <div
                        className={`w-10 h-10 rounded-full ${
                          chat.color === "bg-pink-500" || chat.color === "bg-pink-600" 
                            ? "bg-purple-700" 
                            : chat.color.includes("purple-") 
                              ? "bg-purple-800" 
                              : chat.color
                        } flex items-center justify-center text-white font-bold mr-3 shadow-md`}
                      >
                        {chat.avatar}
                      </div>
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center max-w-md p-6 bg-white rounded-xl shadow-lg">
              ...
              <button
                onClick={() => setShowInviteModal(true)}
                className="py-2 px-6 bg-gradient-to-r from-purple-700 to-purple-600 text-white font-medium rounded-lg
                hover:from-purple-800 hover:to-purple-700 transition duration-200 shadow-md"
              >
                Join Discord Server
              </button>
