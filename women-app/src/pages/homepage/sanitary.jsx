...
const Sanitarys = () => {
  ...
  const infographicGuides = [
    {
      ...
      steps: [
        {
          id: 1,
          title: "Choose the Right Pad",
          description:
            "Choose a pad of the appropriate thickness, absorbency, shape and style.",
          image: Image1,
          tips: [
            "Different flows need different absorbencies",
            "Consider wings for better protection",
            "Overnight pads are longer for sleeping positions",
          ],
        },
        {
          id: 2,
          ...
          description:
            "Get in a comfortable position that gives you access to place the pad.",
          image: Image2,
          tips: [
            "Sitting on a toilet works well",
            "Standing with one foot elevated is another option",
            "Make sure you have enough privacy and time",
          ],
        },
        {
          id: 3,
          title: "Unwrap the Pad",
          description: "Remove any wrappers or boxes from the pad.",
          image: Image3,
          tips: [
            "Keep the wrapper for disposal later",
            "Be careful not to tear the pad",
            "Some pads have pull tabs to make unwrapping easier",
          ],
        },
        {
          id: 4,
          ...
          description:
            "Unfold the wings and take off the backing that covers the adhesive on the center.",
          image: Image4,
          tips: [
            "Don't remove wing adhesive backings yet",
            "Make sure pad is fully unfolded",
            "Check that the pad isn't twisted",
          ],
        },
        {
          id: 5,
          title: "Attach to Underwear",
          description: "Stick the adhesive parts to your underwear.",
          image: Image5,
          tips: [
            "Center the pad in the underwear",
            "Press firmly to secure adhesive",
            "Wrap wings around the underwear edges and stick",
          ],
        },
        {
          id: 6,
          title: "Wear Normally",
          description: "Wear your underwear as usual.",
          image: Image6,
          tips: [
            "Make sure the pad feels secure",
            "Adjust if it feels uncomfortable",
            "The wider end typically goes toward the back",
          ],
        },
        {
          id: 7,
          title: "Choose Comfortable Clothes",
          description: "Opt for more comfortable clothes.",
          image: Image8,
          tips: [
            "Loose-fitting clothes reduce pad visibility",
            "Dark-colored bottoms can help with leak anxiety",
            "Cotton fabrics are breathable and comfortable",
          ],
        },
        {
          id: 8,
          ...
          tips: [
            ...
            "This prevents spreading germs and infections",
          ],
        },
      ],
    },
      ...
      steps: [
        {
          ...
          description: "Wash your hands before opening the tampon wrapper.",
          image: Step1,
          tips: [
            "Use soap and warm water",
            "Wash for at least 20 seconds",
        ...
        },
        {
          ...
          description: "Sit or stand in a comfortable position.",
          image: Step2,
          tips: [
            "Try sitting on the toilet with knees apart",
            "Some prefer standing with one foot on the toilet",
            "Find what works best for you",
          ],
        },
        {
          id: 3,
          title: "Hold the Tampon Correctly",
          description: "Hold the tampon with the fingers you write with.",
          image: Step3,
          tips: [
            "Grip the middle of the applicator",
            "Hold it at the grip marks if present",
            "Make sure the string hangs down freely",
          ],
        },
        {
          id: 4,
          title: "Find Your Vagina",
          description:
            "Explore your body with your fingers to find your vagina.",
          image: Step4,
          tips: [
            "The vaginal opening is between the urethra and anus",
            "Using a mirror can help locate it",
        ...
        },
        {
          ...
          description: "Press the tip of the tampon into your vagina.",
          image: Step5,
          tips: [
        ...
        },
        {
          ...
          description: "Push the plunger in with your index finger.",
          image: Step6,
          tips: [
            "Push it all the way in",
            "This moves the tampon into the correct position",
            "The outer tube should be inside the vaginal opening before pushing",
          ],
        },
        {
          id: 7,
          ...
          description:
            "Take out the applicator with your thumb and middle finger.",
          image: Step7,
          tips: [
            "The string should hang outside your body",
            "You shouldn't feel the tampon if it's in correctly",
      ...
      steps: [
        {
          id: 1,
          title: "Wash Your Hands",
          description: "Wash your hands thoroughly before touching the cup.",
          image: S1,
          tips: [
            "Use soap and warm water",
            "Wash for at least 20 seconds",
        ...
        },
        {
          ...
          title: "Wash the Cup",
          description:
            "Wash your cup with a mild soap before using it the first time.",
          image: S2,
          tips: [
            "Use unscented, mild soap",
            "Rinse thoroughly to remove all soap residue",
            "Boil the cup for 5 minutes before first use for sterilization",
          ],
        },
        {
          id: 3,
          title: "Get Into Position",
          description: "Squat or raise one leg up on the toilet.",
          image: S3,
          tips: [
            "Squatting helps open the vaginal canal",
            "You can also try sitting on the toilet",
        ...
        },
        {
          id: 4,
          title: "Fold the Cup",
          description: "Fold the cup to make it easier to insert.",
          image: S4,
          tips: [
            "Try the C-fold or Punch-down fold",
            "Hold it firmly to keep the fold in place",
            "Experiment with different folds to find the easiest one for you",
          ],
        },
        {
          id: 5,
          title: "Relax Your Muscles",
          description: "Relax your muscles as much as you can.",
          image: S5,
          tips: [
            "Tension can make insertion more difficult",
            "Take deep breaths to stay calm",
            "Try inserting the cup in the shower for added comfort",
          ],
        },
        {
          id: 6,
          title: "Insert the Cup",
          description:
            "Insert the cup into your vagina, angling it toward your tailbone.",
          image: S6,
          tips: [
            "Push it in gently until the entire cup is inside",
            "Make sure the stem is not sticking out too much",
            "You may need to wiggle it slightly to adjust placement",
          ],
        },
        {
          id: 7,
          title: "Ensure a Proper Seal",
          description: "Twist the cup to make sure it seals properly.",
          image: S7,
          tips: [
            "Rotate the cup slightly to ensure it's fully open",
            "Run a finger around the base to check for folds",
            "A sealed cup prevents leaks and stays in place",
          ],
        },
      ],
    },
    {
      ...
      steps: [
        {
          id: 1,
          title: "Remove the Used Pad",
          description:
            "Remove the used pad from your underwear and roll it up.",
          image: I1,
          tips: [
            "Peel the pad off gently to avoid tearing",
            "Fold it in half with the sticky side inside",
            "This makes disposal easier",
          ],
        },
        {
          id: 2,
          title: "Wrap the Pad",
          description: "Wrap the pad in a piece of paper.",
          image: I2,
          tips: [
            "Use toilet paper or the wrapper from a new pad",
            "Wrapping helps contain any odor",
            "Avoid flushing the pad as it can clog drains",
          ],
        },
        {
          id: 3,
          title: "Dispose of the Pad",
          description: "Put the wrapped pad in the garbage can.",
          image: I3,
          tips: [
            "Use a bin with a lid to minimize odor",
            "Dispose of it in a designated sanitary waste bin if available",
            "Avoid throwing it in an open trash can",
          ],
        },
        {
          id: 4,
          title: "Wash Your Hands",
          description: "Wash your hands when you are done.",
          image: I4,
          tips: [
            "Use soap and warm water",
            "Wash for at least 20 seconds",
        ...
        },
        {
          ...
          description:
            "Take out the garbage bag with the used pad in it as soon as possible.",
          image: I5,
          tips: [
            "Dispose of the trash regularly to prevent odor",
            "Use a small bag that can be changed frequently",
            "Consider using biodegradable disposal bags",
          ],
        },
      ],
    },
  ...
  const categories = [
    ...new Set(educationalVideos.map((video) => video.category)),
  ];
      ...
      <div className="flex-1 p-6 ml-40">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold text-purple-800 mb-2">
            Sanitary Products Education
          </h1>
          <p className="text-gray-600 mb-6">
            Learn everything you need to know about menstrual products and how
            to use them.
          </p>
                    ...
                    >
                      {getVideosByCategory(category)?.map((video) => (
                        <motion.div
                          ...
                          className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 hover:-translate-y-1 group"
                        >
                          <div className="relative pb-[56.25%] overflow-hidden">
                            <img
                              src={video.thumbnail || "fallback-image.jpg"}
                            ...
                            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                              <button
                                className="bg-white bg-opacity-90 text-purple-700 rounded-full p-3 hover:scale-110 transition-transform duration-300 scale-75 group-hover:scale-100"
                                onClick={(e) => {
                                  e.stopPropagation();
                                  openVideo(video.id);
                                }}
                          ...
                          >
                            ...
                            <p className="text-gray-600 text-sm line-clamp-2">
                              {video.description ||
                                "Learn about proper usage techniques and health tips"}
                            </p>
                          </div>
                        </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {infographicGuides.map((guide) => (
                  <div
                    ...
                    onClick={() =>
                      guide.steps.length > 0 && openGuide(guide.id)
                    }
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${guide.color} opacity-90`}
                    ></div>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 p-6 bg-gradient-to-br from-purple-50 to-pink-50">
                    <div className="bg-white rounded-xl shadow-md p-6">
                      ...
                      <h3 className="text-2xl font-bold text-purple-900 mb-4 hidden md:block">
                        {getCurrentStep().title}
                      </h3>
            ...
            <div className="px-6 py-3 bg-gray-50 border-t border-gray-200">
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${
                      (currentStep / getCurrentGuide()?.steps.length) * 100
                    }%`,
                  }}
                ></div>
              </div>
