...
import { CheckCircle, Circle, AlertCircle, ChevronLeft, ChevronRight, Info, Lightbulb, Recycle, Leaf, DropletOff, Heart,Flame, Factory,Wind } from 'lucide-react';
...
const Burns = () => {
  ...
  const disposalSteps = [
    ...
    {
      icon: "alert",
      title: "Marine Life Ingestion",
      description: "Fish and marine animals mistakenly consume broken-down pad fibers and plastic particles.",
      impact: "Ingested plastics can lead to internal injuries, malnutrition, and disruption of marine ecosystems.",
    },
    {
      icon: "alert",
